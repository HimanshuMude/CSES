   ...
   */
    ...
    void solve(){
        ...
        while(q--)
        {
            ...
            while(1)
            {
                nums=9LL*binpowmod(10LL,dig-1)*dig;
                if(k<nums) break;
                k-=nums;
                dig++;
            }
            ...
            // debug(dig,k);
            ll completeNums=k/dig;
            // debug(completeNums);
            ll nextCompleteNum=binpowmod(10LL,dig-1)+completeNums;
            // debug(nextCompleteNum);
            ll index=k%dig;
            // debug(index);
            if(index==0) cout<<(nextCompleteNum-1LL)%10LL<<"\n";
            else cout<<to_string(nextCompleteNum)[index-1]<<"\n";
